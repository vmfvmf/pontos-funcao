...
export class CT56 extends TestCase {
    loginPage: LoginPage;
    ...
    public async setup() {
        ...
        this.usuario = GPOLICASTRO; // UM USUÁRIO COM LOTAÇÃO NO LDAP MAS INATIVA NO SIGEP
    }
    ...
    public async eval() {
        await this.telaInicial.validarLotacaoInativaUsuarioLogado(this.usuario);
    }
