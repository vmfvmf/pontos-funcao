...
export class CT57 extends TestCase {
  loginPage: LoginPage;
  ...
  public async setup() {
    ...
    this.usuario = GPOLICASTRO; // UM USUÁRIO COM LOTAÇÃO NÃO CADASTRADA NO LDAP MAS ATIVA NO SIGEP
  }
  ...
  public async eval() {
    await this.telaInicial.validarLotacaoNaoLDAPUsuarioLogado(this.usuario);
  }
}
