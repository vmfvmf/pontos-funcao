...
export class CT77 extends TestCase {
  loginPage: LoginPage;
  usuario: IUsuario;
  ...
  public async setup() {
    ...
    // A lotação do usuário está autorizada, no mecanismo de controle de acesso (CAC), a utilizar o sistema
    this.usuario = { login: 'gpolicastro', senha: 'Senha123?' }; // UM USUÁRIO AUTORIZADO POR LOTAÇÃO
  }
