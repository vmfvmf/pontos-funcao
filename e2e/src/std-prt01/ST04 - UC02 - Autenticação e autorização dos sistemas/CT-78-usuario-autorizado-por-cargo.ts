...
export class CT78 extends TestCase {
  loginPage: LoginPage;
  usuario: IUsuario;
  ...
  public async setup() {
    ...
    // O cargo do usuário está autorizado, no mecanismo de controle de acesso (CAC), a utilizar o sistema.
    this.usuario = { login: 'gpolicastro', senha: 'Senha123?' }; // UM USUÁRIO AUTORIZADO POR CARGO
  }
